$(function(){
    ...
    var adaptObject = function (element, defaults, option, template, plugin, pluginName) {
        var $this = element;
        ...
        return $this.each(function () {
            ...
            var data = el.data('dia.' + pluginName);


            if (!data) el.data('dia.' + pluginName,
    ...
    $.fn.adaptObject = $.adaptObject= adaptObject;
});